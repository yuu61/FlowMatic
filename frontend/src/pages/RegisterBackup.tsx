...
function RegisterBackup() {
  ...
  return (
    <main className="flex-1 p-8 overflow-y-auto flex items-center justify-center min-h-screen bg-gray-100">
      <section
        id="login"
        className="content-section w-full max-w-md bg-white p-8 rounded-xl shadow-lg border border-gray-200"
      >
        <h2 className="text-4xl font-extrabold text-gray-800 mb-8 text-center">Register</h2>

        <form id="loginForm" onSubmit={handleSubmit}>
          <div className="mb-6">
            <label htmlFor="username" className="block text-gray-700 text-sm font-bold mb-4">
              Username
            </label>
            <input
              type="text"
